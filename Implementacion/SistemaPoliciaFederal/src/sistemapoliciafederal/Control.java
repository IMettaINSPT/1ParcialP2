...
// ver si puede quedar final
    ...
    public void dummyDeserializar() throws IOException, ClassNotFoundException {
        ...
        sistemaState.deSerializar("PoliciaFederal.txt");
        System.out.println("Cantidad de banda :" + sistemaState.getBandas().size());
    }
    ...
    public void dummyTest() throws IOException {
        ...
        usuarios.add(UsuarioAdmin.crearUsuario("aa", "aa", sistemaState));
        ...
        sistemaState.serializar("PoliciaFederal.txt");
